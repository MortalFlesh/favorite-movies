...
/**
 * @ORM\Entity(repositoryClass="MF\FavoriteMovies\GraphQL\Repository\ActorRepository")
 */
class Actor implements MoviePartInterface, UniquePartInterface
{
    ...
    private $link;
    /**
     * @ORM\ManyToMany(targetEntity="MF\FavoriteMovies\GraphQL\Entity\Movie", inversedBy="actors")
